...
function useAppearance() {
  ...
  query.onchange = (e) => {if (userPreference === 'auto') {setClass((isDark.value = e.matches))}}
...
<template>
  <VTSwitch class="vt-switch-appearance" :aria-label="config.i18n?.ariaDarkMode ?? 'Toggle dark mode'"
