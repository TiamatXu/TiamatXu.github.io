...
<template>
  <div v-if="config.algolia" class="VPNavBarSearch">
    ...
    <div v-if="!loaded" id="docsearch" @click="load">
      <button type="button" class="DocSearch DocSearch-Button" :aria-label="config.i18n?.search ?? 'Search'">
        <span class="DocSearch-Button-Container">
          ...
          <span class="DocSearch-Button-Placeholder">{{ config.i18n?.search ?? 'Search' }}</span>
        </span>
        <ClientOnly>
