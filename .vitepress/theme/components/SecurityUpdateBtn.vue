...
.container .security {
  ...
  border-radius: 8px;
  background:
    linear-gradient(var(--vt-c-bg-mute), var(--vt-c-bg-mute)) padding-box,
...
.container .security:hover {
  background:
    linear-gradient(var(--vt-c-gray-light-4), var(--vt-c-gray-light-4)) padding-box,
    linear-gradient(45deg, #42d392, #647eff) border-box;
...
.dark .container .security:hover {
  background:
    linear-gradient(var(--vt-c-gray-dark-3), var(--vt-c-gray-dark-3)) padding-box,
    linear-gradient(45deg, #42d392, #647eff) border-box;
}
